    ...
    <div className="App">
      <div className="App-content">
        <div className="App-col-flex-box">
          ...
          <p>We cordially invite you to the auspicious occasion of Griha Pravesh of their new residence, Gayatri Kripa.<br/>22nd July, 2021<br/>4:00 PM</p>
        </div>
